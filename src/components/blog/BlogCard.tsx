  ...
  return (
    ...
    >
      <div className="relative overflow-hidden aspect-[16/9]">
        ...
        {post.featured && (
          <div className="absolute top-4 left-4">
            <span className="bg-primary-orange text-white px-3 py-1 text-xs font-medium">
              Featured
            </span>
          </div>
        )}
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <Link
          href={`/blog/${post.slug}`}
          className="text-primary-orange text-sm font-medium flex items-center mt-auto hover:text-deep-orange transition-colors duration-300"
        >
          Read More
          <svg
