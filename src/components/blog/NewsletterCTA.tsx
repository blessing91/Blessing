        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-sm focus:outline-none focus:ring-2 focus:ring-primary-orange"
            />
          ...
          <button
            type="submit"
            className="bg-primary-orange hover:bg-deep-orange text-white px-6 py-3 rounded-sm font-medium transition-colors duration-300"
          >
            {buttonText}
          </button>
        </form>
